    ...
    <KeyboardAvoidingView style={styles.root} behavior={Platform.OS === "ios" ? "padding" : "height"}>
      <LinearGradient colors={["#1e1b4b", "#2e1a6e"]} style={[styles.header, { paddingTop: topInset + 20 }]}>
        ...
        <Text style={styles.headerSubtitle}>
          {sent ? "Check your inbox for reset instructions" : "No worries, we'll send you reset instructions"}
        </Text>
      </LinearGradient>
        ...
        {!sent ? (
          <View style={styles.form}>
            <View style={styles.fieldGroup}>
              ...
              <Text style={styles.fieldHint}>Enter the email associated with your account</Text>
            </View>
          ...
          <View style={styles.successWrap}>
            ...
            <View style={styles.tipsCard}>
              ...
              <View style={styles.tipRow}>
                ...
                <Text style={styles.tipText}>Check your inbox (and spam folder)</Text>
              </View>
              <View style={styles.tipRow}>
                <View style={styles.tipNumber}><Text style={styles.tipNumberText}>2</Text></View>
                <Text style={styles.tipText}>Click the reset link in the email</Text>
              </View>
              <View style={styles.tipRow}>
                <View style={styles.tipNumber}><Text style={styles.tipNumberText}>3</Text></View>
                <Text style={styles.tipText}>Create a new secure password</Text>
              </View>
            </View>

            <Pressable style={({ pressed }) => [styles.submitBtn, pressed && { opacity: 0.88 }]} onPress={() => router.push({ pathname: "/(auth)/reset-password", params: { email } })}>
              <LinearGradient colors={["#7c3aed", "#6d28d9"]} style={styles.submitGradient}>
                <Text style={styles.submitText}>Open Reset Link</Text>
                <ArrowRight size={18} color="#fff" />
              </LinearGradient>
            </Pressable>
...
const styles = StyleSheet.create({
  ...
  fieldHint: { fontSize: 12, color: "#8b7dc0", fontFamily: "Inter_400Regular", marginTop: 2 },
  ...
  helperRow: { flexDirection: "row", justifyContent: "center", gap: 6, marginTop: 4 },
  helperText: { fontSize: 13, color: "#8b7dc0", fontFamily: "Inter_400Regular" },
  ...
  successIconGrad: { width: 88, height: 88, borderRadius: 44, alignItems: "center", justifyContent: "center", shadowColor: "#10b981", shadowOpacity: 0.4, shadowRadius: 14, shadowOffset: { width: 0, height: 6 }, elevation: 10 },
  successTitle: { fontSize: 22, fontFamily: "Inter_700Bold", color: "#1e1b4b" },
  successDesc: { fontSize: 14, color: "#6b6b8d", fontFamily: "Inter_400Regular", textAlign: "center", lineHeight: 20 },
  successEmail: { color: "#7c3aed", fontFamily: "Inter_700Bold" },
  tipsCard: { width: "100%", backgroundColor: "#ffffff", borderRadius: 16, padding: 18, gap: 12, borderWidth: 1, borderColor: "#e5e0f8", marginTop: 8 },
  tipsTitle: { fontSize: 13, fontFamily: "Inter_700Bold", color: "#1e1b4b", marginBottom: 4 },
  tipRow: { flexDirection: "row", alignItems: "center", gap: 12 },
  tipNumber: { width: 24, height: 24, borderRadius: 12, backgroundColor: "#f0eeff", alignItems: "center", justifyContent: "center" },
  tipNumberText: { fontSize: 11, fontFamily: "Inter_700Bold", color: "#7c3aed" },
  tipText: { flex: 1, fontSize: 13, fontFamily: "Inter_500Medium", color: "#4c1d95" },
  resendBtn: { flexDirection: "row", alignItems: "center", gap: 6, paddingVertical: 8 },
  resendText: { fontSize: 13, color: "#7c3aed", fontFamily: "Inter_600SemiBold" },
});
