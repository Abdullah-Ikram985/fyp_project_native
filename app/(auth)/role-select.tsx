    ...
    >
      ...
      >
        ...
        <Pressable
          style={({ pressed }) => [
            styles.continueBtn,
            !role && styles.continueBtnDisabled,
            pressed && role && { opacity: 0.88 },
          ]}
        ...
        >
          ...
          >
            <Text
              style={[
                styles.continueText,
                !role && { color: 'rgba(196,181,253,0.5)' },
              ]}
            >
              Continue
            </Text>
  ...
  return (
    ...
    >
      ...
      <View style={styles.roleTop}>
        <LinearGradient colors={iconColors} style={styles.roleIcon}>
          {icon}
        </LinearGradient>
        <View style={{ flex: 1 }}>
